...
public class TinyReluActivation implements ActivationI {
    private static final Logger LOG = Logger.getLogger(TinyReluActivation.class.getName());
    private Matrix dYdZ;
    private String actName = ActE.TINY_RELU.label;
    private double leftSlope = 0.005;
    private double rightSlope = 0.1;
    //
    public TinyReluActivation() {
